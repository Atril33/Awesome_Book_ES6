import myBookShowList from './modules/BookShow.js';
import myShowContactView from './modules/ContactShow.js';
import myAddBookList from './modules/BookAdd.js';
import myRedirectButton from './modules/RedirectButton.js';
import { DateTime } from './modules/luxon.js';

const Error = document.getElementById('error');
const myText = document.getElementById('text');
const myDate = document.getElementById('date');
const myLuxon = DateTime.local(new Date()).c;
console.log(myLuxon);
myDate.innerHTML = `${myLuxon.year}, ${myLuxon.month}, ${myLuxon.day}, ${myLuxon.hour}, ${myLuxon.minute}, ${myLuxon.second}`;
